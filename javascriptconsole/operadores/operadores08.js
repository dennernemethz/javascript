// operadores aritimeticos javascrips Math()
...
console.log(res)*/ // 1.0: arrendonda para o inteiro mais proximo 

/*let n1 = 10 
res = Math.ceil(.10)

console.log(res)*/  // 1.0: arredonda para cima para um inteiro
